...
class DTree:
    ...
    def predict_labeled(self, features, root = True):
        ...
        :param features: pd.DataFrame of test features
        :return: predicted labels + leaf id labels (from label_leaves)
    ...
    def label_leaves(self, current_count=None):
        """ I added this function to add labels in the form of numbers to all leaves of the tree,
        this way it is easy to refer to a leaf. """
    ...
    def to_graphviz_labeled(self, choice='', parent='R', graph=None, size='15,15', root=True):
        ...
        """Same as the original to_graphviz, but adds a leaf id (from label_leaves) to each leaf"""
